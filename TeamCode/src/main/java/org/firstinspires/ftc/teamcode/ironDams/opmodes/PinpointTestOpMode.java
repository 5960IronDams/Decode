    ...
    public Action tuneAction() {
        return new Action() {
            ...
            public boolean run(@NonNull TelemetryPacket packet) {
                ...
                logger.writeToCache(timer.milliseconds(), "voltage", voltageSensor.getVoltage());
                logger.writeToCache(timer.milliseconds(), "x", pos.getX(DistanceUnit.INCH));
                logger.writeToCache(timer.milliseconds(), "y", pos.getY(DistanceUnit.INCH));
                logger.writeToCache(timer.milliseconds(), "heading", pos.getHeading(AngleUnit.DEGREES));
